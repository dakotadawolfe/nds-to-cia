...
with zipfile.ZipFile(release/'NDS-to-CIA-1.0.0-Windows-x64.zip','w',zipfile.ZIP_DEFLATED) as archive:
    for name in files:archive.write(release/name,'NDS-to-CIA/'+name)
checks=[]
for name in ('NDS-to-CIA.exe','Bridge.cia','NDS-to-CIA-1.0.0-Windows-x64.zip','NDS-to-CIA-1.0.0-Source.zip'):
